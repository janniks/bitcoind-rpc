export interface RpcCallSpec {
  ...
  abandontransaction: ({
    ...
    /** `string` The transaction id — required */
    txid: string;
  }) => Promise<any>;
  ...
  addmultisigaddress: ({
    ...
    /** `numeric` The number of required signatures out of the n keys or addresses — required */
    nrequired: number;
    /** `json array` The bitcoin addresses or hex-encoded public keys — required */
    keys: any[];
    /** `string` A label to assign the addresses to — defaults to `optional` */
    label?: string;
    /** `string` The address type to use. Options are "legacy", "p2sh-segwit", and "bech32" — defaults to `set by -addresstype` */
    address_type?: string;
  }) => Promise<any>;
  ...
  addnode: ({
    ...
    /** `string` The node (see getpeerinfo for nodes) — required */
    node: string;
    /** `string` 'add' to add a node to the list, 'remove' to remove a node from the list, 'onetry' to try a connection to the node once — required */
    command: string;
  }) => Promise<any>;
  ...
  analyzepsbt: ({
    ...
    /** `string` A base64 string of a PSBT — required */
    psbt: string;
  }) => Promise<any>;
  ...
  backupwallet: ({
    ...
    /** `string` The destination directory or file — required */
    destination: string;
  }) => Promise<any>;
  ...
  bumpfee: ({
    ...
    /** `string` The txid to be bumped — required */
    txid: string;
    /** `json object` defaults to `optional` */
    options?: any;
  }) => Promise<any>;
  ...
  combinepsbt: ({
    ...
    /** `json array` The base64 strings of partially signed transactions — required */
    txs: any[];
  }) => Promise<any>;
  ...
  combinerawtransaction: ({
    ...
    /** `json array` The hex strings of partially signed transactions — required */
    txs: any[];
  }) => Promise<any>;
  ...
  converttopsbt: ({
    ...
    /** `string` The hex string of a raw transaction — required */
    hexstring: string;
    /** `boolean` If true, any signatures in the input will be discarded and conversion — defaults to `false` */
    permitsigdata?: boolean;
    /** `boolean` Whether the transaction hex is a serialized witness transaction — defaults to `depends on heuristic tests` */
    iswitness?: boolean;
  }) => Promise<any>;
  ...
  createmultisig: ({
    ...
    /** `numeric` The number of required signatures out of the n keys — required */
    nrequired: number;
    /** `json array` The hex-encoded public keys — required */
    keys: any[];
    /** `string` The address type to use. Options are "legacy", "p2sh-segwit", and "bech32" — defaults to `legacy` */
    address_type?: string;
  }) => Promise<any>;
  ...
  createpsbt: ({
    ...
    /** `json array` The json objects — required */
    inputs: any[];
    /** `json array` The outputs (key-value pairs), where none of the keys are duplicated — required */
    outputs: any[];
    /** `numeric` Raw locktime. Non-0 value also locktime-activates inputs — defaults to `0` */
    locktime?: number;
    /** `boolean` Marks this transaction as BIP125 replaceable — defaults to `false` */
    replaceable?: boolean;
  }) => Promise<any>;
  ...
  createrawtransaction: ({
    ...
    /** `json array` The inputs — required */
    inputs: any[];
    /** `json array` The outputs (key-value pairs), where none of the keys are duplicated — required */
    outputs: any[];
    /** `numeric` Raw locktime. Non-0 value also locktime-activates inputs — defaults to `0` */
  ...
  createwallet: ({
    ...
    /** `string` The name for the new wallet. If this is a path, the wallet will be created at the path location — required */
    wallet_name: string;
    /** `boolean` Disable the possibility of private keys (only watchonlys are possible in this mode) — defaults to `false` */
    disable_private_keys?: boolean;
    /** `boolean` Create a blank wallet. A blank wallet has no keys or HD seed. One can be set using sethdseed — defaults to `false` */
    blank?: boolean;
    /** `string` Encrypt the wallet with this passphrase — defaults to `string` */
    passphrase?: string;
    /** `boolean` Keep track of coin reuse, and treat dirty and clean coins differently with privacy considerations in mind — defaults to `false` */
    avoid_reuse?: boolean;
    /** `boolean` Create a native descriptor wallet. The wallet will use descriptors internally to handle address creation — defaults to `false` */
    descriptors?: boolean;
    /** `boolean` Save wallet name to persistent settings and load on startup. True to add wallet to startup list, false to remove, null to leave unchanged — defaults to `null` */
  ...
  decodepsbt: ({
    ...
    /** `string` The PSBT base64 string — required */
    psbt: string;
  }) => Promise<any>;
  ...
  decoderawtransaction: ({
    ...
    /** `string` The transaction hex string — required */
    hexstring: string;
    /** `boolean` Whether the transaction hex is a serialized witness transaction — defaults to `depends on heuristic tests` */
    iswitness?: boolean;
  }) => Promise<any>;
  ...
  decodescript: ({
    ...
    /** `string` the hex-encoded script — required */
    hexstring: string;
  }) => Promise<any>;
  ...
  deriveaddresses: ({
    ...
    /** `string` The descriptor — required */
    descriptor: string;
    /** `numeric or array` If a ranged descriptor is used, this specifies the end or the range (in [begin,end] notation) to derive — defaults to `optional` */
    range?: number | number[];
  }) => Promise<any>;
  ...
  disconnectnode: ({
    ...
    /** `string` The IP address/port of the node — defaults to `fallback to nodeid` */
    address?: string;
    /** `numeric` The node ID (see getpeerinfo for node IDs) — defaults to `fallback to address` */
    nodeid?: number;
  }) => Promise<any>;
  ...
  dumpprivkey: ({
    ...
    /** `string` The bitcoin address for the private key — required */
    address: string;
  }) => Promise<any>;
  ...
  dumpwallet: ({
    ...
    /** `string` The filename with path (absolute path recommended) — required */
    filename: string;
  }) => Promise<any>;
  ...
  encryptwallet: ({
    ...
    /** `string` The pass phrase to encrypt the wallet with. It must be at least 1 character, but should be long — required */
    passphrase: string;
  }) => Promise<any>;
  ...
  estimatesmartfee: ({
    ...
    /** `numeric` Confirmation target in blocks (1 - 1008) — required */
    conf_target: number;
    /** `string` The fee estimate mode — defaults to `CONSERVATIVE` */
  ...
  finalizepsbt: ({
    ...
    /** `string` A base64 string of a PSBT — required */
    psbt: string;
    /** `boolean` If true and the transaction is complete, — defaults to `true` */
    extract?: boolean;
  }) => Promise<any>;
  ...
  fundrawtransaction: ({
    ...
    /** `string` The hex string of the raw transaction — required */
    hexstring: string;
    /** `json object` for backward compatibility: passing in a true instead of an object will result in {"includeWatching":true} — defaults to `optional` */
    options?: any;
    /** `boolean` Whether the transaction hex is a serialized witness transaction — defaults to `depends on heuristic tests` */
    iswitness?: boolean;
  }) => Promise<any>;
  ...
  generateblock: ({
    ...
    /** `string` The address or descriptor to send the newly generated bitcoin to — required */
    output: string;
    /** `json array` An array of hex strings which are either txids or raw transactions — required */
    transactions: any[];
  }) => Promise<any>;
  ...
  generatetoaddress: ({
    ...
    /** `numeric` How many blocks are generated immediately — required */
    nblocks: number;
    /** `string` The address to send the newly generated bitcoin to — required */
    address: string;
    /** `numeric` How many iterations to try — defaults to `1000000` */
    maxtries?: number;
  }) => Promise<any>;
  ...
  generatetodescriptor: ({
    ...
    /** `numeric` How many blocks are generated immediately — required */
    num_blocks: number;
    /** `string` The descriptor to send the newly generated bitcoin to — required */
    descriptor: string;
    /** `numeric` How many iterations to try — defaults to `1000000` */
    maxtries?: number;
  }) => Promise<any>;
  ...
  getaddednodeinfo: ({
    ...
    /** `string` If provided, return information about this specific node, otherwise all nodes are returned — defaults to `all nodes` */
    node?: string;
  }) => Promise<any>;
  ...
  getaddressinfo: ({
    ...
    /** `string` The bitcoin address for which to get information — required */
    address: string;
  }) => Promise<any>;
  ...
  getbalance: ({
    ...
    /** `string` Remains for backward compatibility. Must be excluded or set to "*" — defaults to `optional` */
    dummy?: string;
    /** `numeric` Only include transactions confirmed at least this many times — defaults to `0` */
    minconf?: number;
    /** `boolean` Also include balance in watch-only addresses (see 'importaddress') — defaults to `otherwise false` */
    include_watchonly?: boolean;
    /** `boolean` (only available if avoid_reuse wallet flag is set) Do not include balance in dirty outputs; addresses are considered dirty if they have previously been used in a transaction — defaults to `true` */
    avoid_reuse?: boolean;
  }) => Promise<any>;
  ...
  getblock: ({
    ...
    /** `string` The block hash — required */
    blockhash: string;
    /** `numeric` 0 for hex-encoded data, 1 for a json object, and 2 for json object with transaction data — defaults to `1` */
    verbosity?: number;
  }) => Promise<any>;
  ...
  getblockfilter: ({
    ...
    /** `string` The hash of the block — required */
    blockhash: string;
    /** `string` The type name of the filter — defaults to `basic` */
    filtertype?: string;
  }) => Promise<any>;
  ...
  getblockhash: ({
    ...
    /** `numeric` The height index — required */
    height: number;
  }) => Promise<any>;
  ...
  getblockheader: ({
    ...
    /** `string` The block hash — required */
    blockhash: string;
    /** `boolean` true for a json object, false for the hex-encoded data — defaults to `true` */
    verbose?: boolean;
  }) => Promise<any>;
  ...
  getblockstats: ({
    ...
    /** `string or numeric` The block hash or height of the target block — required */
    hash_or_height: string | number;
    /** `json array` Values to plot (see result below) — defaults to `all values` */
    stats?: any[];
  }) => Promise<any>;
  ...
  getblocktemplate: ({
    ...
    /** `json object` Format of the template — defaults to `{}` */
    template_request?: any;
  }) => Promise<any>;
  ...
  getchaintxstats: ({
    ...
    /** `numeric` Size of the window in number of blocks — defaults to `one month` */
    nblocks?: number;
    /** `string` The hash of the block that ends the window — defaults to `chain tip` */
    blockhash?: string;
  }) => Promise<any>;
  ...
  getindexinfo: ({
    ...
    /** `string` Filter results for an index with a specific name — defaults to `optional` */
    index_name?: string;
  }) => Promise<any>;
  ...
  getmemoryinfo: ({
    ...
    /** `string` determines what kind of information is returned — defaults to `"stats"` */
    mode?: string;
  }) => Promise<any>;
  ...
  getmempoolancestors: ({
    ...
    /** `string` The transaction id (must be in mempool) — required */
    txid: string;
    /** `boolean` True for a json object, false for array of transaction ids — defaults to `false` */
    verbose?: boolean;
  }) => Promise<any>;
  ...
  getnetworkhashps: ({
    ...
    /** `numeric` The number of blocks, or -1 for blocks since last difficulty change — defaults to `120` */
    nblocks?: number;
    /** `numeric` To estimate at the time of the given height — defaults to `-1` */
    height?: number;
  }) => Promise<any>;
  ...
  getnewaddress: ({
    ...
    /** `string` The label name for the address to be linked to. It can also be set to the empty string "" to represent the default label. The label does not need to exist, it will be created if there is no label by the given name — defaults to `""` */
    label?: string;
    /** `string` The address type to use. Options are "legacy", "p2sh-segwit", and "bech32" — defaults to `set by -addresstype` */
    address_type?: string;
  }) => Promise<any>;
  ...
  getnodeaddresses: ({
    ...
    /** `numeric` The maximum number of addresses to return. Specify 0 to return all known addresses — defaults to `1` */
    count?: number;
  }) => Promise<any>;
  ...
  getrawchangeaddress: ({
    ...
    /** `string` The address type to use. Options are "legacy", "p2sh-segwit", and "bech32" — defaults to `set by -changetype` */
    address_type?: string;
  }) => Promise<any>;
  ...
  getrawmempool: ({
    ...
    /** `boolean` True for a json object, false for array of transaction ids — defaults to `false` */
    verbose?: boolean;
    /** `boolean` If verbose=false, returns a json object with transaction list and mempool sequence number attached — defaults to `false` */
  ...
  getrawtransaction: ({
    ...
    /** `string` The transaction id — required */
    txid: string;
    /** `boolean` If false, return a string, otherwise return a json object — defaults to `false` */
    verbose?: boolean;
    /** `string` The block in which to look for the transaction — defaults to `optional` */
    blockhash?: string;
  }) => Promise<any>;
  ...
  getreceivedbyaddress: ({
    ...
    /** `string` The bitcoin address for transactions — required */
    address: string;
    /** `numeric` Only include transactions confirmed at least this many times — defaults to `1` */
    minconf?: number;
  }) => Promise<any>;
  ...
  getreceivedbylabel: ({
    ...
    /** `string` The selected label, may be the default label using "" — required */
    label: string;
    /** `numeric` Only include transactions confirmed at least this many times — defaults to `1` */
    minconf?: number;
  }) => Promise<any>;
  ...
  gettransaction: ({
    ...
    /** `string` The transaction id — required */
    txid: string;
    /** `boolean` Whether to include watch-only addresses in balance calculation and details[] — defaults to `otherwise false` */
    include_watchonly?: boolean;
    /** `boolean` Whether to include a `decoded` field containing the decoded transaction (equivalent to RPC decoderawtransaction) — defaults to `false` */
    verbose?: boolean;
  }) => Promise<any>;
  ...
  gettxout: ({
    ...
    /** `string` The transaction id — required */
    txid: string;
    /** `numeric` vout number — required */
    n: number;
    /** `boolean` Whether to include the mempool. Note that an unspent output that is spent in the mempool won't appear — defaults to `true` */
  ...
  gettxoutproof: ({
    ...
    /** `json array` The txids to filter — required */
    txids: any[];
    /** `string` If specified, looks for txid in the block with this hash — defaults to `optional` */
    blockhash?: string;
  }) => Promise<any>;
  ...
  gettxoutsetinfo: ({
    ...
    /** `string` Which UTXO set hash should be calculated. Options: 'hash_serialized_2' (the legacy algorithm), 'none' — defaults to `hash_serialized_2` */
    hash_type?: string;
  }) => Promise<any>;
  ...
  help: ({
    ...
    /** `string` The command to get help on — defaults to `all commands` */
    command?: string;
  }) => Promise<any>;
  ...
  importaddress: ({
    ...
    /** `string` The Bitcoin address (or hex-encoded script) — required */
    address: string;
    /** `string` An optional label — defaults to `""` */
    label?: string;
    /** `boolean` Rescan the wallet for transactions — defaults to `true` */
    rescan?: boolean;
  }) => Promise<any>;
  ...
  importdescriptors: ({
    ...
    /** `json array` Data to be imported — required */
    requests: any[];
  }) => Promise<any>;
  ...
  importprivkey: ({
    ...
    /** `string` The private key (see dumpprivkey) — required */
    privkey: string;
    /** `string` An optional label — defaults to `otherwise ""` */
    label?: string;
    /** `boolean` Rescan the wallet for transactions — defaults to `true` */
    rescan?: boolean;
  }) => Promise<any>;
  ...
  importprunedfunds: ({
    ...
    /** `string` A raw transaction in hex funding an already-existing address in wallet — required */
    rawtransaction: string;
    /** `string` The hex output from gettxoutproof that contains the transaction — required */
    txoutproof: string;
  }) => Promise<any>;
  ...
  importpubkey: ({
    ...
    /** `string` The hex-encoded public key — required */
    pubkey: string;
    /** `string` An optional label — defaults to `""` */
    label?: string;
    /** `boolean` Rescan the wallet for transactions — defaults to `true` */
  ...
  importwallet: ({
    ...
    /** `string` The wallet file — required */
    filename: string;
  }) => Promise<any>;
  ...
  keypoolrefill: ({
    ...
    /** `numeric` The new keypool size — defaults to `100` */
    newsize?: number;
  }) => Promise<any>;
  ...
  listlabels: ({
    ...
    /** `string` Address purpose to list labels for ('send','receive'). An empty string is the same as not providing this argument — defaults to `optional` */
    purpose?: string;
  }) => Promise<any>;
  ...
  listreceivedbyaddress: ({
    ...
    /** `numeric` The minimum number of confirmations before payments are included — defaults to `1` */
    minconf?: number;
    /** `boolean` Whether to include addresses that haven't received any payments — defaults to `false` */
    include_empty?: boolean;
    /** `boolean` Whether to include watch-only addresses (see 'importaddress') — defaults to `otherwise false` */
    include_watchonly?: boolean;
    /** `string` If present, only return information on this address — defaults to `optional` */
  ...
  listreceivedbylabel: ({
    ...
    /** `numeric` The minimum number of confirmations before payments are included — defaults to `1` */
    minconf?: number;
    /** `boolean` Whether to include labels that haven't received any payments — defaults to `false` */
    include_empty?: boolean;
    /** `boolean` Whether to include watch-only addresses (see 'importaddress') — defaults to `otherwise false` */
    include_watchonly?: boolean;
  }) => Promise<any>;
  ...
  listsinceblock: ({
    ...
    /** `string` If set, the block hash to list transactions since, otherwise list all transactions — defaults to `optional` */
    blockhash?: string;
    /** `numeric` Return the nth block hash from the main chain. e.g. 1 would mean the best block hash. Note: this is not used as a filter, but only affects [lastblock] in the return value — defaults to `1` */
    target_confirmations?: number;
    /** `boolean` Include transactions to watch-only addresses (see 'importaddress') — defaults to `otherwise false` */
    include_watchonly?: boolean;
    /** `boolean` Show transactions that were removed due to a reorg in the "removed" array — defaults to `true` */
  ...
  listtransactions: ({
    ...
    /** `string` If set, should be a valid label name to return only incoming transactions — defaults to `optional` */
    label?: string;
    /** `numeric` The number of transactions to return — defaults to `10` */
    count?: number;
    /** `numeric` The number of transactions to skip — defaults to `0` */
    skip?: number;
    /** `boolean` Include transactions to watch-only addresses (see 'importaddress') — defaults to `otherwise false` */
    include_watchonly?: boolean;
  }) => Promise<any>;
  ...
  listunspent: ({
    ...
    /** `numeric` The minimum confirmations to filter — defaults to `1` */
    minconf?: number;
    /** `numeric` The maximum confirmations to filter — defaults to `9999999` */
    maxconf?: number;
    /** `json array` The bitcoin addresses to filter — defaults to `empty array` */
    addresses?: any[];
    /** `boolean` Include outputs that are not safe to spend — defaults to `true` */
    include_unsafe?: boolean;
    /** `json object` JSON with query options — defaults to `optional` */
    query_options?: any;
  }) => Promise<any>;
  ...
  loadwallet: ({
    ...
    /** `string` The wallet directory or .dat file — required */
    filename: string;
    /** `boolean` Save wallet name to persistent settings and load on startup. True to add wallet to startup list, false to remove, null to leave unchanged — defaults to `null` */
    load_on_startup?: boolean;
  }) => Promise<any>;
  ...
  lockunspent: ({
    ...
    /** `boolean` Whether to unlock (true) or lock (false) the specified transactions — required */
    unlock: boolean;
    /** `json array` The transaction outputs and within each, the txid (string) vout (numeric) — defaults to `empty array` */
    transactions?: any[];
  }) => Promise<any>;
  ...
  logging: ({
    ...
    /** `json array` The categories to add to debug logging — defaults to `optional` */
    include?: any[];
    /** `json array` The categories to remove from debug logging — defaults to `optional` */
    exclude?: any[];
  }) => Promise<any>;
  ...
  preciousblock: ({
    ...
    /** `string` the hash of the block to mark as precious — required */
    blockhash: string;
  }) => Promise<any>;
  ...
  prioritisetransaction: ({
    ...
    /** `string` The transaction id — required */
    txid: string;
    /** `numeric` API-Compatibility for previous API. Must be zero or null — defaults to `optional` */
    dummy?: number;
    /** `numeric` The fee value (in satoshis) to add (or subtract, if negative) — required */
    fee_delta: number;
  }) => Promise<any>;
  ...
  pruneblockchain: ({
    ...
    /** `numeric` The block height to prune up to. May be set to a discrete height, or to a UNIX epoch time — required */
    height: number;
  }) => Promise<any>;
  ...
  removeprunedfunds: ({
    ...
    /** `string` The hex-encoded id of the transaction you are deleting — required */
    txid: string;
  }) => Promise<any>;
  ...
  rescanblockchain: ({
    ...
    /** `numeric` block height where the rescan should start — defaults to `0` */
    start_height?: number;
    /** `numeric` the last block height that should be scanned. If none is provided it will rescan up to the tip at return time of this call — defaults to `optional` */
    stop_height?: number;
  }) => Promise<any>;
  ...
  scantxoutset: ({
    ...
    /** `string` The action to execute — required */
    action: string;
    /** `json array` Array of scan objects. Required for "start" action — defaults to `json array` */
    scanobjects?: any[];
  }) => Promise<any>;
  ...
  send: ({
    ...
    /** `json array` The outputs (key-value pairs), where none of the keys are duplicated — required */
    outputs: any[];
    /** `numeric` Confirmation target in blocks — defaults to `wallet -txconfirmtarget` */
    conf_target?: number;
    /** `string` The fee estimate mode, must be one of (case insensitive): — defaults to `unset` */
    estimate_mode?: string;
    /** `numeric or string` Specify a fee rate in sat/vB — defaults to `fall back to wallet fee estimation` */
  ...
  sendmany: ({
    ...
    /** `string` Must be set to "" for backwards compatibility — required */
    dummy: string;
    /** `json object` The addresses and amounts — required */
    amounts: any;
    /** `numeric` Ignored dummy value — defaults to `optional` */
    minconf?: number;
    /** `string` A comment — defaults to `optional` */
    comment?: string;
    /** `json array` The addresses — defaults to `optional` */
    subtractfeefrom?: any[];
    /** `boolean` Allow this transaction to be replaced by a transaction with higher fees via BIP 125 — defaults to `wallet default` */
    replaceable?: boolean;
    /** `numeric` Confirmation target in blocks — defaults to `wallet -txconfirmtarget` */
    conf_target?: number;
    /** `string` The fee estimate mode, must be one of (case insensitive): — defaults to `unset` */
    ...
    /** `numeric or string` Specify a fee rate in sat/vB — defaults to `fall back to wallet fee estimation` */
    fee_rate?: number | string;
    /** `boolean` If true, return extra infomration about the transaction — defaults to `false` */
    verbose?: boolean;
  }) => Promise<any>;
  ...
  sendrawtransaction: ({
    ...
    /** `string` The hex string of the raw transaction — required */
    hexstring: string;
    /** `numeric or string` Reject transactions whose fee rate is higher than the specified value, expressed in BTC/kB — defaults to `0.10` */
  ...
  sendtoaddress: ({
    ...
    /** `string` The bitcoin address to send to — required */
    address: string;
    /** `numeric or string` The amount in BTC to send. eg 0.1 — required */
    amount: number | string;
    /** `string` A comment used to store what the transaction is for — defaults to `optional` */
    comment?: string;
    /** `string` A comment to store the name of the person or organization — defaults to `optional` */
    comment_to?: string;
    /** `boolean` The fee will be deducted from the amount being sent — defaults to `false` */
    ...
    /** `string` The fee estimate mode, must be one of (case insensitive): — defaults to `unset` */
    estimate_mode?: string;
    /** `boolean` (only available if avoid_reuse wallet flag is set) Avoid spending from dirty addresses; addresses are considered — defaults to `true` */
    avoid_reuse?: boolean;
    /** `numeric or string` Specify a fee rate in sat/vB — defaults to `fall back to wallet fee estimation` */
    fee_rate?: number | string;
    /** `boolean` If true, return extra information about the transaction — defaults to `false` */
    verbose?: boolean;
  }) => Promise<any>;
  ...
  setban: ({
    ...
    /** `string` The IP/Subnet (see getpeerinfo for nodes IP) with an optional netmask (default is /32 = single IP) — required */
    subnet: string;
    /** `string` 'add' to add an IP/Subnet to the list, 'remove' to remove an IP/Subnet from the list — required */
    command: string;
    /** `numeric` time in seconds how long (or until when if [absolute] is set) the IP is banned (0 or empty means using the default time of 24h which can also be overwritten by the -bantime startup argument) — defaults to `0` */
    bantime?: number;
    /** `boolean` If set, the bantime must be an absolute timestamp expressed in UNIX epoch time — defaults to `false` */
    absolute?: boolean;
  }) => Promise<any>;
  ...
  sethdseed: ({
    ...
    /** `boolean` Whether to flush old unused addresses, including change addresses, from the keypool and regenerate it — defaults to `true` */
    newkeypool?: boolean;
    /** `string` The WIF private key to use as the new HD seed — defaults to `random seed` */
    seed?: string;
  }) => Promise<any>;
  ...
  setlabel: ({
    ...
    /** `string` The bitcoin address to be associated with a label — required */
    address: string;
    /** `string` The label to assign to the address — required */
    label: string;
  }) => Promise<any>;
  ...
  setnetworkactive: ({
    ...
    /** `boolean` true to enable networking, false to disable — required */
    state: boolean;
  }) => Promise<any>;
  ...
  settxfee: ({
    ...
    /** `numeric or string` The transaction fee in BTC/kvB — required */
    amount: number | string;
  }) => Promise<any>;
  ...
  setwalletflag: ({
    ...
    /** `string` The name of the flag to change. Current available flags: avoid_reuse — required */
    flag: string;
    /** `boolean` The new state — defaults to `true` */
    value?: boolean;
  }) => Promise<any>;
  ...
  signmessage: ({
    ...
    /** `string` The bitcoin address to use for the private key — required */
    address: string;
    /** `string` The message to create a signature of — required */
    message: string;
  }) => Promise<any>;
  ...
  signmessagewithprivkey: ({
    ...
    /** `string` The private key to sign the message with — required */
    privkey: string;
    /** `string` The message to create a signature of — required */
    message: string;
  }) => Promise<any>;
  ...
  signrawtransactionwithkey: ({
    ...
    /** `string` The transaction hex string — required */
    hexstring: string;
    /** `json array` The base58-encoded private keys for signing — required */
    privkeys: any[];
    /** `json array` The previous dependent transaction outputs — defaults to `optional` */
    prevtxs?: any[];
    /** `string` The signature hash type. Must be one of: — defaults to `ALL` */
    sighashtype?: string;
  }) => Promise<any>;
  ...
  submitblock: ({
    ...
    /** `string` the hex-encoded block data to submit — required */
    hexdata: string;
    /** `string` dummy value, for compatibility with BIP22. This value is ignored — defaults to `ignored` */
    dummy?: string;
  }) => Promise<any>;
  ...
  submitheader: ({
    ...
    /** `string` the hex-encoded block header data — required */
    hexdata: string;
  }) => Promise<any>;
  ...
  testmempoolaccept: ({
    ...
    /** `json array` An array of hex strings of raw transactions — required */
    rawtxs: any[];
    /** `numeric or string` Reject transactions whose fee rate is higher than the specified value, expressed in BTC/kB — defaults to `0.10` */
    maxfeerate?: number | string;
  }) => Promise<any>;
  ...
  unloadwallet: ({
    ...
    /** `string` The name of the wallet to unload. Must be provided in the RPC endpoint or this parameter (but not both) — defaults to `the wallet name from the RPC endpoint` */
    wallet_name?: string;
    /** `boolean` Save wallet name to persistent settings and load on startup. True to add wallet to startup list, false to remove, null to leave unchanged — defaults to `null` */
    load_on_startup?: boolean;
  }) => Promise<any>;
  ...
  upgradewallet: ({
    ...
    /** `numeric` The version number to upgrade to. Default is the latest wallet version — defaults to `169900` */
    version?: number;
  }) => Promise<any>;
  ...
  utxoupdatepsbt: ({
    ...
    /** `string` A base64 string of a PSBT — required */
    psbt: string;
    /** `json array` An array of either strings or objects — defaults to `optional` */
    descriptors?: any[];
  }) => Promise<any>;
  ...
  validateaddress: ({
    ...
    /** `string` The bitcoin address to validate — required */
    address: string;
  }) => Promise<any>;
  ...
  verifychain: ({
    ...
    /** `numeric` How thorough the block verification is: — defaults to `range=0-4` */
    checklevel?: number;
    /** `numeric` The number of blocks to check — defaults to `0=all` */
    nblocks?: number;
  }) => Promise<any>;
  ...
  verifymessage: ({
    ...
    /** `string` The bitcoin address to use for the signature — required */
    address: string;
    /** `string` The signature provided by the signer in base 64 encoding (see signmessage) — required */
    signature: string;
    /** `string` The message that was signed — required */
    message: string;
  }) => Promise<any>;
  ...
  verifytxoutproof: ({
    ...
    /** `string` The hex-encoded proof generated by gettxoutproof — required */
    proof: string;
  }) => Promise<any>;
  ...
  walletcreatefundedpsbt: ({
    ...
    /** `json array` Leave empty to add inputs automatically. See add_inputs option — defaults to `optional` */
    inputs?: any[];
    /** `json array` The outputs (key-value pairs), where none of the keys are duplicated — required */
    outputs: any[];
    /** `numeric` Raw locktime. Non-0 value also locktime-activates inputs — defaults to `0` */
  ...
  walletpassphrase: ({
    ...
    /** `string` The wallet passphrase — required */
    passphrase: string;
    /** `numeric` The time to keep the decryption key in seconds; capped at 100000000 (~3 years) — required */
    timeout: number;
  }) => Promise<any>;
  ...
  walletpassphrasechange: ({
    ...
    /** `string` The current passphrase — required */
    oldpassphrase: string;
    /** `string` The new passphrase — required */
  ...
  walletprocesspsbt: ({
    ...
    /** `string` The transaction base64 string — required */
    psbt: string;
    /** `boolean` Also sign the transaction when updating — defaults to `true` */
    sign?: boolean;
    /** `string` The signature hash type to sign with if not specified by the PSBT. Must be one of — defaults to `ALL` */
    sighashtype?: string;
  }) => Promise<any>;
}
